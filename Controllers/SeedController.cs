    ...
    public class SeedController : ControllerBase
    {
        ...
        public async Task<IActionResult> BoardGameData()
        {
            ...
            foreach (var record in records)
            {
                ...
                {
                    foreach (
                        var domainName in record.Domains.Split(',', StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries)
                ...
                {
                    foreach (
                        var mechanicName in record.Mechanics.Split(',', StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries)
                        .Distinct(StringComparer.InvariantCultureIgnoreCase)
                    )
                    {
        ...
        public async Task<IActionResult> AuthData()
        {
            ...
            return new JsonResult(new
            {
                ...
                UsersAddedToRoles = usersAddToRoles
            });
        }
    }
}